...
import 'package:aezakmi_finance_task/controllers/add_goals_controller.dart';

class AddGoalsScreen extends StatelessWidget {
  final _controller = Get.put(AddGoalsController());
  AddGoalsScreen({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Padding(
        ...
        child: ListView(
          children: [
            CustomAppbarWidget(title: "Add financial goal"),
